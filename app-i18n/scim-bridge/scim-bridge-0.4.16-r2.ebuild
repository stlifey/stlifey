...
src_install() {
	...
	XINITRCFCITX="${D}/etc/X11/xinit/xinitrc.d/02-scim-bridge"

	echo "#! /bin/bash"  > "${XINITRCFCITX}"

	echo "export GTK_IM_MODULE=scim-bridge" >> "${XINITRCFCITX}"
	echo "export QT_IM_MODULE=scim-bridge" >> "${XINITRCFCITX}"
