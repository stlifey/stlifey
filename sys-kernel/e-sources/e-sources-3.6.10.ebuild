...
uksm_src="${uksm_url}/download/uksm/${uksm_version}/uksm-${uksm_main_version}-for-v${BASE_VERSION}.ge.${uksm_sub_version}.patch"
use uksm && UKSM_PATCHES="${DISTDIR}/uksm-${uksm_main_version}-for-v${BASE_VERSION}.ge.${uksm_sub_version}.patch:1"
